...
//MPI_Allgatherv. ¬ каждом из p процессов создать матрицу A p x
//n, заполненную значени€ми aij = i и вектор B из n Ц rank элементов, заполненный значени€ми bi = rank, 
//где rank Ц номер процесса. аждый процесс посылает в каждый процесс свой вектор B из n Ц rank элементов.
// аждый процесс должен разместить полученные элементы в соответствующие строки своей матрицы ј(в 0 - ую строку Ц от 0 - го процесса, в
//1 - ую Ц от 1 - го и т.д.), остальные элементы строк обнулить.
